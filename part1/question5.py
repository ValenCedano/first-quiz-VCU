...
sql_create_favorite_foods = ''' CREATE TABLE favorite_foods (food_id integer,
name text,
vegetarian integer); '''
...
SELECT a.name, fo.name
FROM animals a
INNER JOIN favorite_foods fo ON a.favorite_food_id = fo.food_id
